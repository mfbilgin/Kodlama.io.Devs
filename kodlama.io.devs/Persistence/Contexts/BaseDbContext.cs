...
namespace Persistence.Contexts
{
    public class BaseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            LanguageTechnology[] languageTechnologyEntitySeed =
                { new(1, 1, "WPF"), new(2, 2, "Spring"), new(3, 5, "Laravel") };
            modelBuilder.Entity<LanguageTechnology>().HasData(languageTechnologyEntitySeed);
